...
front.prototype = {
    ...
    _updateResources: function() {
        var trasferVars = {
            allyId: ikariam.model.avatarAllyId,
            actionRequest: ikariam.model.actionRequest,
            resources: ikariam.model.currentResources,
            cities: ikariam.model.relatedCityData,
            separators: {thousand: LocalizationStrings.thousandSeperator, decimal: LocalizationStrings.decimalPoint},
